...
class Aruco3d:
    def __init__(self):
            ...
            # Publicando os ids e distancias dos arucos detectados
            self.infos_arucos_pub = rospy.Publisher('/aruco_info', PoseArray, queue_size=1)
